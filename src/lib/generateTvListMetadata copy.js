...
export const generateMetadata = async () => {
  return {
    title:
      "TV Series with Sinhala Subtitles (2025) – Stream & Download | MovieMania.lk",
    description:
      "Watch the newest TV series with Sinhala subtitles in HD. Filter by genre, year, IMDb rating, or search by name. No ads, fast servers, daily updates.",
    keywords: [
    ...
    openGraph: {
      ...
      description:
        "The biggest collection of TV series with Sinhala subtitles—updated daily.",
      images: [
        {
    ...
    twitter: {
      ...
      title: "TV Series with Sinhala Subtitles (2025) – Stream & Download",
      description:
        "Fast HD streaming & download of every trending series with Sinhala subs.",
